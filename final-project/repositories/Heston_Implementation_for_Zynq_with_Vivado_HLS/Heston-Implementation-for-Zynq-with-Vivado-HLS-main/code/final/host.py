...
if __name__ == "__main__":
    ...
    ol = Overlay("/home/xilinx/6_5eng_100M/design_2.bit")
    #print(dir(ol.design_1_0.S_AXI_SLV0_0))
    
    mytwist0 = ol.engine_new_0.S_AXI_SLV0_0
    myheston0= ol.engine_new_0.S_AXI_PARAMS_0
    DMA0=ol.axi_dma_0
    
    mytwist1 = ol.engine_new_1.S_AXI_SLV0_0
    myheston1= ol.engine_new_1.S_AXI_PARAMS_0
    DMA1=ol.axi_dma_1
    
    mytwist2 = ol.engine_new_2.S_AXI_SLV0_0
    myheston2= ol.engine_new_2.S_AXI_PARAMS_0
    DMA2=ol.axi_dma_2
    
    mytwist3 = ol.engine_new_3.S_AXI_SLV0_0
    myheston3= ol.engine_new_3.S_AXI_PARAMS_0
    DMA3=ol.axi_dma_3
    
    mytwist4 = ol.engine_new_4.S_AXI_SLV0_0
    myheston4= ol.engine_new_4.S_AXI_PARAMS_0
    DMA4=ol.axi_dma_4
    
    mytwist5 = ol.engine_new_5.S_AXI_SLV0_0
    myheston5= ol.engine_new_5.S_AXI_PARAMS_0
    DMA5=ol.axi_dma_5
    
    mytwist6 = ol.engine_crippled_0.S_AXI_SLV0_0
    myheston6= ol.engine_crippled_0.S_AXI_PARAMS_0
    DMA6=ol.axi_dma_6
    ...
    output6 = allocate(shape=(path_cnt,), dtype=np.float32)
    ...
    for i in range(624):
       ...
       mytwist6.write(0x1000+i*4,random.randint(-2**16+2,2**16-2))
    ...
    myheston6.write(0x14,log_spot_price)
    myheston6.write(0x1c,0x3b000000)
    myheston6.write(0x24,long_term_avg_vola)
    myheston6.write(0x2c,0x3d800000)
    myheston6.write(0x34,0x00000000)
    myheston6.write(0x3c,vola_0)
    myheston6.write(0x44,0x00000000)
    myheston6.write(0x4c,0x42c80000)
    myheston6.write(0x54,step_cnt)
    myheston6.write(0x5c,0x3b000000)
    myheston6.write(0x64,0x3d800000)
    myheston6.write(0x6c,BARRIER_HIT_CORRECTION)
    myheston6.write(0x74,path_cnt)
    ...
    DMA6.recvchannel.transfer(output6)
