...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { cofm_i_TDATA { I 512 vector } cofm_i_TVALID { I 1 bit } cofm_i_TREADY { O 1 bit } cofm_o_TDATA { O 512 vector } cofm_o_TVALID { O 1 bit } cofm_o_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ofm_buff0_0_address0 { O 5 vector } ofm_buff0_0_ce0 { O 1 bit } ofm_buff0_0_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ofm_buff0_1_address0 { O 5 vector } ofm_buff0_1_ce0 { O 1 bit } ofm_buff0_1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ofm_buff0_2_address0 { O 5 vector } ofm_buff0_2_ce0 { O 1 bit } ofm_buff0_2_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ofm_buff0_3_address0 { O 5 vector } ofm_buff0_3_ce0 { O 1 bit } ofm_buff0_3_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ofm_buff0_4_address0 { O 5 vector } ofm_buff0_4_ce0 { O 1 bit } ofm_buff0_4_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ofm_buff0_5_address0 { O 5 vector } ofm_buff0_5_ce0 { O 1 bit } ofm_buff0_5_q0 { I 32 vector } } \
} "
} else {
