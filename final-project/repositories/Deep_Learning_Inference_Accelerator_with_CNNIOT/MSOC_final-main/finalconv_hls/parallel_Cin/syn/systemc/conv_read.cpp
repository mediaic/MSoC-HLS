...
conv_read::conv_read(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_5_fu_243_p7);
    ...
    sc_trace(mVcdFile, tmp_5_fu_243_p7, "tmp_5_fu_243_p7");
...
void conv_read::thread_cofm_b5_addr1516_par_fu_259_p5() {
    cofm_b5_addr1516_par_fu_259_p5 = esl_partset<512,512,192,32,32>(cofm_i_TDATA.read(), tmp_5_fu_243_p7.read(), ap_const_lv32_0, ap_const_lv32_BF);
}
...
void conv_read::thread_tmp_5_fu_243_p7() {
    tmp_5_fu_243_p7 = esl_concat<160,32>(esl_concat<128,32>(esl_concat<96,32>(esl_concat<64,32>(esl_concat<32,32>(bitcast_ln241_fu_239_p1.read(), bitcast_ln240_fu_235_p1.read()), bitcast_ln239_fu_231_p1.read()), bitcast_ln238_fu_227_p1.read()), bitcast_ln237_fu_223_p1.read()), bitcast_ln236_fu_219_p1.read());
}
