...
architecture behav of write_row_ifm is 
    ...
    signal add_ln82_fu_141_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln82_reg_214 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln85_fu_159_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2, enable_read_read_fu_64_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    add_ln82_fu_141_p2 <= std_logic_vector(unsigned(cifm_counter_read) + unsigned(ap_const_lv32_22));
    ap_CS_fsm_state1 <= ap_CS_fsm(0);
    ap_CS_fsm_state2 <= ap_CS_fsm(1);
    ap_CS_fsm_state3 <= ap_CS_fsm(2);

    ap_block_state2_assign_proc : process(cifm_TVALID, icmp_ln82_fu_147_p2)
    begin
                ap_block_state2 <= ((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_cifm_counter_1_phi_fu_135_p4_assign_proc : process(enable_read_read_fu_64_p2, add_ln82_reg_214, cifm_counter_1_reg_132, ap_CS_fsm_state3)
    begin
        if (((enable_read_read_fu_64_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    cifm_TDATA_blk_n_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if (((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    cifm_TREADY_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln82_fu_147_p2 <= "1" when (j_0_reg_121 = ap_const_lv6_22) else "0";
    ifm_buff0_0_address0 <= zext_ln85_fu_168_p1(6 - 1 downto 0);

    ifm_buff0_0_ce0_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ifm_buff0_0_d0 <= trunc_ln85_fu_159_p1;

    ifm_buff0_0_we0_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ifm_buff0_1_address0 <= zext_ln85_fu_168_p1(6 - 1 downto 0);

    ifm_buff0_1_ce0_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ifm_buff0_1_we0_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ifm_buff0_2_address0 <= zext_ln85_fu_168_p1(6 - 1 downto 0);

    ifm_buff0_2_ce0_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ifm_buff0_2_we0_assign_proc : process(cifm_TVALID, ap_CS_fsm_state2, icmp_ln82_fu_147_p2)
    begin
        if ((not(((icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (cifm_TVALID = ap_const_logic_0))) and (icmp_ln82_fu_147_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    trunc_ln85_fu_159_p1 <= cifm_TDATA(32 - 1 downto 0);
    zext_ln85_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_121),64));
end behav;
