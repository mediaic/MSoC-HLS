...
// ==============================================================
#ifndef __pool_hw_fcmp_32nsbkb__HH__
#define __pool_hw_fcmp_32nsbkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pool_hw_fcmp_32nsbkb) {
    ...
    SC_CTOR(pool_hw_fcmp_32nsbkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
