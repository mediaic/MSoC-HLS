...
void ecdsa_verify(ap_uint<256> hash, ap_uint<256> Qx, ap_uint<256> Qy, ap_uint<256> r, ap_uint<256> s, bool& ifValid) {
...
#pragma HLS INTERFACE s_axilite port=ifValid
...
int main() {
    ...
    ecdsa_verify(m, Qx, Qy, r, s, ifValid);
