...
#pragma HLS RESOURCE variable=input_memcpy_buffer0 core=RAM_2P_BRAM
	static int input_memcpy_buffer1[(OnChipIB_Width+3)/2];
#pragma HLS RESOURCE variable=input_memcpy_buffer1 core=RAM_2P_BRAM
	static int input_memcpy_buffer2[(OnChipIB_Width+3)/2];
#pragma HLS RESOURCE variable=input_memcpy_buffer2 core=RAM_2P_BRAM
	static int input_memcpy_buffer3[(OnChipIB_Width+3)/2];
#pragma HLS RESOURCE variable=input_memcpy_buffer3 core=RAM_2P_BRAM
...
#pragma HLS RESOURCE variable=input_memcpy_buffer02 core=RAM_2P_BRAM
	static int input_memcpy_buffer12[(OnChipIB_Width+3)/2];
#pragma HLS RESOURCE variable=input_memcpy_buffer12 core=RAM_2P_BRAM
	static int input_memcpy_buffer22[(OnChipIB_Width+3)/2];
#pragma HLS RESOURCE variable=input_memcpy_buffer22 core=RAM_2P_BRAM
	static int input_memcpy_buffer32[(OnChipIB_Width+3)/2];
#pragma HLS RESOURCE variable=input_memcpy_buffer32 core=RAM_2P_BRAM
...
#pragma HLS RESOURCE variable=weight_memcpy_buffer core=RAM_2P_BRAM
	static int weight_memcpy_buffer1[Tm*Tn/2];
#pragma HLS RESOURCE variable=weight_memcpy_buffer1 core=RAM_2P_BRAM
...
#pragma HLS RESOURCE variable=local_beta_buffer core=RAM_2P_BRAM
...
#pragma HLS RESOURCE variable=partial_mul core=RAM_2P_BRAM
