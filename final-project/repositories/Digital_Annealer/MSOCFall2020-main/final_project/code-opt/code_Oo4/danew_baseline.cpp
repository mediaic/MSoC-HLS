...
double calculate_energy(double distance_matrix[citysize][citysize], bool qubit_matrix[citysize][citysize])
{
  //i order
  //k city
...
double calculate_delta_energy(double distance_matrix[citysize][citysize], bool qubit_matrix[citysize][citysize], int i, int j)
{
     double H = 0, HA = 0 , HB = 0, HC = 0;
     int sgn;
     int Bi = 0, Ci = 0;
...
void execute_replica0(struct Replica* replica, ap_uint<32> &lfsr){  
  ...
  #pragma HLS loop_tripcount min=1 max=5 avg=2
    ...
    for(int i = 0; i < citysize; i++){
      for(int j = 0; j < citysize; j++){
        delta_energy[i][j] = calculate_delta_energy(distance_matrix, replica -> _qubit_matrix,i,j) - Eoff;// add or minus ?
  ...
  replica->_energy = calculate_energy(distance_matrix, replica->_qubit_matrix);
}
void execute_replica1(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica2(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica3(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica4(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica5(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica6(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica7(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica8(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica9(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica10(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica11(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica12(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica13(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica14(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica15(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica16(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica17(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica18(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void execute_replica19(struct Replica* replica, ap_uint<32> &lfsr){  
  double delta_energy[citysize][citysize] = {};
  bool candidate[citysize][citysize] = {};
  double Eoff = 0;
  int flipx, flipy;
...
void DigitalAnnealer(double A, double _distance_matrix[citysize][citysize], double _beta[replicaNum], bool (&best_qubit_matrix)[citysize][citysize],double &best_energy){
  ...
  double initial_energy = 10*_A;
  best_energy = initial_energy;
  Replica replica0 = {replica0._beta = _beta[0]};replica0._energy = initial_energy;
  Replica replica1 = {replica1._beta = _beta[1]};replica1._energy = initial_energy;
  Replica replica2 = {replica2._beta = _beta[2]};replica2._energy = initial_energy;
  Replica replica3 = {replica3._beta = _beta[3]};replica3._energy = initial_energy;
  Replica replica4 = {replica4._beta = _beta[4]};replica4._energy = initial_energy;
  Replica replica5 = {replica5._beta = _beta[5]};replica5._energy = initial_energy;
  Replica replica6 = {replica6._beta = _beta[6]};replica6._energy = initial_energy;
  Replica replica7 = {replica7._beta = _beta[7]};replica7._energy = initial_energy;
  Replica replica8 = {replica8._beta = _beta[8]};replica8._energy = initial_energy;
  Replica replica9 = {replica9._beta = _beta[9]};replica9._energy = initial_energy;
  Replica replica10 = {replica10._beta = _beta[10]};replica10._energy = initial_energy;
  Replica replica11 = {replica11._beta = _beta[11]};replica11._energy = initial_energy;
  Replica replica12 = {replica12._beta = _beta[12]};replica12._energy = initial_energy;
  Replica replica13 = {replica13._beta = _beta[13]};replica13._energy = initial_energy;
  Replica replica14 = {replica14._beta = _beta[14]};replica14._energy = initial_energy;
  Replica replica15 = {replica15._beta = _beta[15]};replica15._energy = initial_energy;
  Replica replica16 = {replica16._beta = _beta[16]};replica16._energy = initial_energy;
  Replica replica17 = {replica17._beta = _beta[17]};replica17._energy = initial_energy;
  Replica replica18 = {replica18._beta = _beta[18]};replica18._energy = initial_energy;
  Replica replica19 = {replica19._beta = _beta[19]};replica19._energy = initial_energy;     
  ...
  for(int i = 0; i < iteration; i++){
    execute_replica0(&replica0,lfsr0);
    execute_replica1(&replica1,lfsr1);
    execute_replica2(&replica2,lfsr2);
    execute_replica3(&replica3,lfsr3);
    execute_replica4(&replica4,lfsr4);
    execute_replica5(&replica5,lfsr5);
    execute_replica6(&replica6,lfsr6);
    execute_replica7(&replica7,lfsr7);
    execute_replica8(&replica8,lfsr8);
    execute_replica9(&replica9,lfsr9);
    execute_replica10(&replica10,lfsr10);
    execute_replica11(&replica11,lfsr11);
    execute_replica12(&replica12,lfsr12);
    execute_replica13(&replica13,lfsr13);
    execute_replica14(&replica14,lfsr14);
    execute_replica15(&replica15,lfsr15);
    execute_replica16(&replica16,lfsr16);
    execute_replica17(&replica17,lfsr17);
    execute_replica18(&replica18,lfsr18);
    execute_replica19(&replica19,lfsr19);
