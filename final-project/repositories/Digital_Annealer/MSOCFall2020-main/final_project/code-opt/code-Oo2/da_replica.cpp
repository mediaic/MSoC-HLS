...
//#pragma HLS unroll
			execute_replica<0>(&replica[0]);
			calculate_energy<0>(&replica[0]);
			execute_replica<1>(&replica[1]);
			calculate_energy<1>(&replica[1]);
			execute_replica<2>(&replica[2]);
			calculate_energy<2>(&replica[2]);
			execute_replica<3>(&replica[3]);
			calculate_energy<3>(&replica[3]);
			execute_replica<4>(&replica[4]);
			calculate_energy<4>(&replica[4]);
			execute_replica<5>(&replica[5]);
			calculate_energy<5>(&replica[5]);
			execute_replica<6>(&replica[6]);
			calculate_energy<6>(&replica[6]);
			execute_replica<7>(&replica[7]);
			calculate_energy<7>(&replica[7]);
			execute_replica<8>(&replica[8]);
			calculate_energy<8>(&replica[8]);
			execute_replica<9>(&replica[9]);
			calculate_energy<9>(&replica[9]);
