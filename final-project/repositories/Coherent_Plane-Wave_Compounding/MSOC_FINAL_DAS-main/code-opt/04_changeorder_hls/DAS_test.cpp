...
int main () {
  ...
  std::string str;
  echo_file.open("C:/Users/CHI/Desktop/MSOC/00_Final/06_changeorder_hls/src_code/echo_int16.txt");
  output_file.open("C:/Users/CHI/Desktop/MSOC/00_Final/06_changeorder_hls/src_code/out.txt");
